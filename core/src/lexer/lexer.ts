...
function getKeywords(): Record<string, TokenType> {
    return {
        [config.varSyntax]: TokenType.VAR,
        [config.constSyntax]: TokenType.CONST,
        ...
        [config.switchSyntax]: TokenType.SWITCH,
        "case": TokenType.CASE,
        "default": TokenType.DEFAULT,
        ["end" + config.switchSyntax]: TokenType.END_SWITCH,
        "for": TokenType.FOR,
        "to": TokenType.TO,
        "step": TokenType.STEP,
        ...
        "end": TokenType.END,
        "loop": TokenType.LOOP,
        [config.functionSyntax]: TokenType.FUNCTION,
        "return": TokenType.RETURN,
        ["end" + config.functionSyntax]: TokenType.END_FUNCTION,
